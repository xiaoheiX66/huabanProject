...
window.onload = function () {
  ...
  pAjax({
    ...
    res1.cover.forEach(function (item, index) {
      ...
      console.log('dateres=', JSON.parse(res)); // console.log('thirds',thirds);
